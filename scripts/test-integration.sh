...
export DIRECTORY_SERVICE_API_URL="${DIRECTORY_SERVICE_API_URL:-https://directory.invalid}"
export DIRECTORY_SERVICE_API_KEY="${DIRECTORY_SERVICE_API_KEY:-test-directory-service-key}"
